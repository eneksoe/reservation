...
func (m *Repository) RoomOne(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "1.page.gohtml", &models.TemplateData{})
}

func (m *Repository) RoomTwo(w http.ResponseWriter, r *http.Request) {
	render.Template(w, r, "2.page.gohtml", &models.TemplateData{})
}
...
func (m *Repository) AvailabilityJSON(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		resp := jsonResponse{
			OK:      false,
			Message: "Error querying to database",
		}
...
func (m *Repository) AdminPostReservationsCalender(w http.ResponseWriter, r *http.Request) {
	...
	for name, _ := range r.PostForm {
		if strings.HasPrefix(name, "add_block") {
			...
			err := m.DB.InsertBlockFroRoom(roomID, t)
			if err != nil {
				log.Println(err)
			}
		}
